...
- [ ] Unstyled native scrollbars across scroll containers `[ui][bug]`. Scroll regions missing the app's `scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent` utilities (defined `src/app/globals.css:243-268`) fall back to the native scrollbar — on macOS it flips from a dark overlay to a white/grey track on hover, breaking the dark theme. Journaling already fixed (`journaling/page.tsx`, `entry-list.component.tsx`). **Fix:** add the three classes to the element that owns the overflow. Remaining offenders:
  - **A — content scroll areas (do these):** `app/(workspace)/layout.tsx:133` (global `<main>`), `quests/page.tsx:68`, `tasks/_components/tasks-list-board.component.tsx:56`, `tasks/_components/task-list.component.tsx:109`, `tasks/_components/task-matrix-quadrant-card.component.tsx:34`, `calendar/_components/day-details-sheet.component.tsx:60`, `habits/_components/habit-heatmap.component.tsx:140`, `habits/_components/habit-list.component.tsx:13`, `habits/_components/habit-today.component.tsx:63`, `habits/page.tsx:118`, `objectives/_components/objective-summary-list.component.tsx:66,85`, `inventory/_components/armory-tab.component.tsx:79`, `inventory/_components/inventory-grid.component.tsx:113`, `inventory/_components/kill-record-list.component.tsx:45`, `inventory/page.tsx:101,105,109,113`, `guilds/_components/start-campaign-dialog.component.tsx:86`, `(landing)/news/[slug]/page.tsx:62`, `components/combat/combat-action-bar.component.tsx:126,158`, `components/common/chat-room.component.tsx:299`, `components/ui/tiptap-editor.component.tsx:132`.
  - **B — small textareas (`resize-none`, barely visible, optional):** `tasks/_components/create-task-dialog.component.tsx:126`, `tasks/_components/update-task-dialog.component.tsx:159`, `habits/_components/update-habit-dialog.component.tsx:118`.
  - **C — horizontal / tables / code (`overflow-x-auto`, optional):** `mdx-components.tsx:23,32`, `components/ui/table.component.tsx:8`, `habits/_components/habit-heatmap.component.tsx:104`.
  - **D — Radix popovers (verify, likely leave as-is):** `components/ui/select.component.tsx`, `components/ui/dropdown-menu.component.tsx`, `components/forms/multi-select.component.tsx:132`, `components/ui/sidebar.component.tsx`.
