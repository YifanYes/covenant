...
import DropdownMenu, { DropdownMenuContent, DropdownMenuTrigger } from '@/ui/dropdown-menu.component'
import Input from '@/ui/input.component'
import ScrollArea from '@/ui/scroll-area.component'
import { ChevronDown, Cancel as Close, Search } from 'pixelarticons/react'
        ...
        <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
          <DropdownMenuTrigger asChild>
            <Button
              ...
              variant="outline"
              className={cn(
                'hover:bg-accent hover:text-accent-foreground dark:hover:bg-input/50 dark:hover:text-foreground flex h-9 w-full items-center justify-between gap-2 font-normal transition-all duration-200',
