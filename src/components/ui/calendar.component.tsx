'use client'
import { ChevronDown, ChevronLeft, ChevronRight } from 'pixelarticons/react'
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn('text-primary font-semibold rounded-md data-[selected=true]:rounded-none', defaultClassNames.today),
...
function CalendarDayButton({ className, day, modifiers, ...props }: React.ComponentProps<typeof DayButton>) {
  ...
  return (
    <button
      ...
      className={cn(
        'flex aspect-square h-9 w-9 items-center justify-center rounded! p-2 text-sm transition-all duration-200',
        isSelected
