...
import { z } from 'zod'
import { publicIdSchema, slugSchema } from './ids.schemas'
...
export const deleteMessageSchema = z.object({
  messagePublicId: publicIdSchema
})
...
export const campaignIdSchema = z.object({
  campaignPublicId: publicIdSchema
})
